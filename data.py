...
def load_games():
    file = 'data/game_stats.csv'
    use_cols = ['GAME_ID', 'AWAY_TEAM', 'A_FG', 'A_FGA', 'A_FG%', 'A_3P', 'A_3PA', 'A_3P%', 'A_FT', 'A_FTA', 'A_FT%',
                'A_AST', 'A_STL', 'A_BLK', 'A_TOB', 'A_PTS',
                'HOME_TEAM', 'H_FG', 'H_FGA', 'H_FG%', 'H_3P', 'H_3PA', 'H_3P%', 'H_FT', 'H_FTA', 'H_FT%',
                'H_AST', 'H_STL', 'H_BLK', 'H_TOB', 'H_PTS']
